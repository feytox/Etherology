...
public class DecoBlocks {
    ...
    public static final SignType PEACH_SIGN_TYPE = SignType.register(new SignType("peach"));

    // peach wood
    public static final Block PEACH_LOG = register("peach_log", Blocks.createLogBlock(MapColor.BROWN, MapColor.BROWN));
    public static final Block STRIPPED_PEACH_LOG = register("stripped_peach_log", Blocks.createLogBlock(MapColor.SPRUCE_BROWN, MapColor.BROWN));
    ...
    public static final Block PEACH_PLANKS = register("peach_planks", new Block(AbstractBlock.Settings.of(Material.WOOD, MapColor.ORANGE).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block PEACH_SIGN = register("peach_sign", new SignBlock(copy(PEACH_PLANKS).noCollision().strength(1.0f), PEACH_SIGN_TYPE));
    public static final Block PEACH_WALL_SIGN = register("peach_wall_sign", new WallSignBlock(copy(PEACH_PLANKS).noCollision().strength(1.0f), PEACH_SIGN_TYPE));
