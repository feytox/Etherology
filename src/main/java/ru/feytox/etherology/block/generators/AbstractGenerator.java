...
public abstract class AbstractGenerator extends FacingBlock implements RegistrableBlock, BlockEntityProvider {
    ...
    protected AbstractGenerator(Settings settings, String blockId, int minCooldown, int maxCooldown, float stopChance) {
