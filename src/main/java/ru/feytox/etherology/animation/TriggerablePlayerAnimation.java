...
public class TriggerablePlayerAnimation extends AbstractPlayerAnimation {
    ...
    public TriggerablePlayerAnimation(Identifier animationId, boolean firstPerson, boolean shouldBreak, @Nullable Consumer<IAnimatedPlayer> startAction, @Nullable Consumer<IAnimatedPlayer> endAction, Identifier... replacements) {
