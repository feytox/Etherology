...
import ru.feytox.etherology.magic.aspects.AspectNew;
...
public class RegistriesRegistry {
    ...
    public static RegistryKey<Registry<AspectNew>> ASPECT = RegistryKey.ofRegistry(EIdentifier.of("aspect"));
    ...
    public static void registerAll() {
        ...
        DynamicRegistries.registerSynced(ASPECT, AspectNew.JSON_CODEC);
