...
public class EItemGroups {
    ...
    private static void registerMainGroup() {
        ...
        // functional blocks
        etherItems.with(
                BREWING_CAULDRON, PEDESTAL_BLOCK, ARMILLARY_MATRIX, EMPOWERMENT_TABLE, CONSTRUCTOR_TABLE, ETHEREAL_STORAGE,
        ...
        etherItems.with(
                ...
                ETHRIL_RING, TELDER_STEEL_RING, NETHERITE_RING, GLINT, ETHEREAL_OIL, CORRUPTION_BUCKET);
        // plants
