...
public class EItemGroups {
    ...
    private static void registerMainGroup() {
        ...
        // functional blocks
        etherItems.with(
                BREWING_CAULDRON, PEDESTAL_BLOCK, ARMILLARY_SPHERE, EMPOWERMENT_TABLE, INVENTOR_TABLE, JEWELRY_TABLE, ETHEREAL_STORAGE,
                ETHEREAL_FURNACE, ETHEREAL_CHANNEL, CHANNEL_CASE, ETHEREAL_FORK, ETHEREAL_SOCKET, SPINNER, METRONOME,
                ARCANELIGHT_DETECTOR_BLOCK, LEVITATOR, FURNITURE_SLAB, SHELF_SLAB, CLOSET_SLAB,
