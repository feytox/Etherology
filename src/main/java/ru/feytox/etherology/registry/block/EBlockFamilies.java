...
public class EBlockFamilies {
    ...
    static {
        ...
        CLAY_TILE = register(CLAY_TILES).slab(CLAY_TILES_SLAB).stairs(CLAY_TILES_STAIRS).wall(CLAY_TILES_WALL).build();
        BLUE_CLAY_TILE = register(BLUE_CLAY_TILES).slab(BLUE_CLAY_TILES_SLAB).stairs(BLUE_CLAY_TILES_STAIRS).wall(BLUE_CLAY_TILES_WALL).build();
