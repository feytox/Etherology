...
import ru.feytox.etherology.util.nbt.NbtIngredient;
...
public class EArmillaryRecipe {
    private OldArmillaryRecipe recipe;
    ...
    public EArmillaryRecipe(OldArmillaryRecipe recipe) {
...
//        if (!(match.get() instanceof OldArmillaryRecipe recipe)) return null;
//
