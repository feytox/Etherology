...
public class OldArmillaryRecipe implements Recipe<Inventory> {
    ...
    public OldArmillaryRecipe(List<Ingredient> inputs, Ingredient centerInput, int instability,
    ...
    public RecipeSerializer<?> getSerializer() {
        return OldArmillaryRecipeSerializer.INSTANCE;
    }
    ...
    public static class Type implements RecipeType<OldArmillaryRecipe> {
        private Type() {}
        public static final Type INSTANCE = new Type();

        public static final String ID = "armillary_recipe_old";
    }
}
