...
public class OldZoneParticle extends OldMovingParticle {
    public static final int PARTICLE_RADIUS = 8;
    private final SpriteProvider spriteProvider;

    protected OldZoneParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i,
    ...
    public static class KetaFactory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new OldZoneParticle(world, x, y, z, velocityX, velocityY, velocityZ, spriteProvider, EssenceZones.KETA);
        }
    }
    ...
    public static class RelaFactory implements ParticleFactory<DefaultParticleType> {
        ...
        @Override
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new OldZoneParticle(world, x, y, z, velocityX, velocityY, velocityZ, spriteProvider, EssenceZones.RELA);
        }
    }
    ...
    public static class ClosFactory implements ParticleFactory<DefaultParticleType> {
        ...
        @Override
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new OldZoneParticle(world, x, y, z, velocityX, velocityY, velocityZ, spriteProvider, EssenceZones.CLOS);
        }
    }
    ...
    public static class ViaFactory implements ParticleFactory<DefaultParticleType> {
        ...
        @Override
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new OldZoneParticle(world, x, y, z, velocityX, velocityY, velocityZ, spriteProvider, EssenceZones.VIA);
        }
    }
