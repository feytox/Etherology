...
public class OldItemMovingParticle extends OldMovingParticle {
    private final float sampleU;
    private final float sampleV;

    public OldItemMovingParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i,
                                 ItemStack stack) {
