...
public class OldElectricityParticle extends OldMovingParticle {
    protected final SpriteProvider spriteProvider;

    public OldElectricityParticle(ClientWorld clientWorld, double d, double e, double f, double instability, double isCenter, double isPeal, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            ...
            // velocityY = is_center
            // velocityZ = is_peal
            return new OldElectricityParticle(world, x, y, z, velocityX, velocityY, velocityZ, this.spriteProvider);
        }
    }
