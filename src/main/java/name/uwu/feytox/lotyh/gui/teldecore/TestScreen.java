...
import name.uwu.feytox.lotyh.gui.teldecore.pages.*;
import name.uwu.feytox.lotyh.recipes.visual.*;
...
import static name.uwu.feytox.lotyh.ItemsRegistry.DEEP_SHARD;
