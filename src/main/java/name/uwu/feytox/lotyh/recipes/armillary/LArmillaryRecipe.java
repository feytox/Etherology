...
public class LArmillaryRecipe {
    ...
    public LArmillaryRecipe(ArmillaryRecipe recipe) {
        this.recipe = recipe;
    ...
    public LArmillaryRecipe(ArmillaryRecipe recipe, List<Integer> deletedInputs, int lastDeletedIndex) {
        this(recipe);
    ...
    public static LArmillaryRecipe readNbt(NbtCompound nbt, World world) {
        ...
        return new LArmillaryRecipe(recipe, deletedInputs, lastDeletedIndex);
    }
    ...
    public static void writeNbt(LArmillaryRecipe lRecipe, NbtCompound nbt) {
