package name.uwu.feytox.lotyh.items;

import name.uwu.feytox.lotyh.gui.teldecore.TestScreen;
import name.uwu.feytox.lotyh.util.SimpleItem;
...
import static name.uwu.feytox.lotyh.LotyhComponents.*;
...
public class Teldecore extends SimpleItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (world.isClient) {
//            LotyhClient.chapters.current().open();
