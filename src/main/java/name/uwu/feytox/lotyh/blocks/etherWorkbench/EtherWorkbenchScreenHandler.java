...
import name.uwu.feytox.lotyh.util.OutputSlot;
import name.uwu.feytox.lotyh.util.SpecificSlot;
import name.uwu.feytox.lotyh.util.UnspecificSlot;
...
public class EtherWorkbenchScreenHandler extends ScreenHandler {
    ...
    public EtherWorkbenchScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory,
        ...
        super(Lotyh.ETHER_SCREEN_HANDLER, syncId);
