...
import name.uwu.feytox.etherology.util.OutputSlot;
import name.uwu.feytox.etherology.util.SpecificSlot;
import name.uwu.feytox.etherology.util.UnspecificSlot;
