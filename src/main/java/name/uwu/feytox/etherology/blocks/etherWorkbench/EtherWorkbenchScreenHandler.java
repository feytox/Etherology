...
import name.uwu.feytox.etherology.util.feyapi.OutputSlot;
import name.uwu.feytox.etherology.util.feyapi.SpecificSlot;
import name.uwu.feytox.etherology.util.feyapi.UnspecificSlot;
