package name.uwu.feytox.etherology.gui.teldecore.chapters;

import name.uwu.feytox.etherology.gui.teldecore.Chapter;
import name.uwu.feytox.etherology.gui.teldecore.pages.EmptyPage;
import name.uwu.feytox.etherology.gui.teldecore.pages.TextPage;
