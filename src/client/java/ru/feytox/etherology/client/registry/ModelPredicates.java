...
import ru.feytox.etherology.client.item.WarpCounterClient;
...
public class ModelPredicates {
    ...
    public static void registerAll() {
        ...
        register("warp_counter", (stack, world, entity, seed) -> WarpCounterClient.getWarpLevel(stack, world, entity), WARP_COUNTER);
    }
}
